...
@section('content')
    <form class="col-md-12 content" action="{{ route('admin.works.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container form-group">
            ...
            <textarea class="form-control" id="myeditorinstance" name="text" rows="200"></textarea>
        </div>
        <div class="container form-group">
