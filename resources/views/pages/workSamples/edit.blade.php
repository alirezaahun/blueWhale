...
@section('content')
    <div class="form-group row">
        ...
        @foreach ($work->files as $file)
            <div class="card col-md-3" style="width: 18rem;">
                <img class="card-img-top" src="{{ url(env('Blog_Save_Path') . $file->path) }}" alt="Card image cap">
                <div class="card-body">
                    <form action="{{ route('admin.works.destroyImage', $file->id) }}" method="post">
                        @csrf
                        @method('DELETE')
    ...
    <form class="col-md-12 content" action="{{ route('admin.works.update', $work) }}" method="POST"
        ...
        <div class="container form-group">
            ...
            <textarea class="form-control" id="myeditorinstance" name="text" rows="200">{!! $work->text !!}</textarea>
        </div>
        <div class="container form-group">
